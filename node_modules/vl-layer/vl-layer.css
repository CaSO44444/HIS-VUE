...
.notify-btn.active[data-v-56ca3248],
.notify-btn[data-v-56ca3248]:active {
  color: inherit;
...
.btn-default.active[data-v-56ca3248],
.btn-default.hover[data-v-56ca3248],
.btn-default[data-v-56ca3248]:active,
...
.notify-btn-primary.active[data-v-56ca3248],
.notify-btn-primary.hover[data-v-56ca3248],
.notify-btn-primary[data-v-56ca3248]:active,
.notify-btn-primary[data-v-56ca3248]:hover {
  color: #fff;
  background-color: #008df6
}

.notify-btn-default.active[data-v-56ca3248],
.notify-btn-default.hover[data-v-56ca3248],
.notify-btn-default[data-v-56ca3248]:active,
.notify-btn-default[data-v-56ca3248]:hover {
  color: #666
}
...
.notify-btn-success.active[data-v-56ca3248],
.notify-btn-success.hover[data-v-56ca3248],
.notify-btn-success[data-v-56ca3248]:active,
.notify-btn-success[data-v-56ca3248]:hover {
  color: #fff;
...
.notify-btn-info.active[data-v-56ca3248],
.notify-btn-info.hover[data-v-56ca3248],
.notify-btn-info[data-v-56ca3248]:active,
.notify-btn-info[data-v-56ca3248]:hover {
  color: #fff;
...
.notify-btn-warning.active[data-v-56ca3248],
.notify-btn-warning.hover[data-v-56ca3248],
.notify-btn-warning[data-v-56ca3248]:active,
.notify-btn-warning[data-v-56ca3248]:hover {
  color: #fff;
...
.notify-btn-danger.active[data-v-56ca3248],
.notify-btn-danger.hover[data-v-56ca3248],
.notify-btn-danger[data-v-56ca3248]:active,
.notify-btn-danger[data-v-56ca3248]:hover {
  color: #fff;
...
.prompt-btn button[data-v-6c69dd9a]:last-child {
  margin-right: 0
}
...
.vl-notify-main.vl-notify.vl-notify-alert.vl-notify-iframe {
  max-width: initial
}
...
.vl-notify.vl-notify-alert h2.vl-notice-title .icon-remove:hover {
  opacity: .7
}
...
.vl-notify.vl-notify-alert h2.vl-notice-title .lv-icon-maxmini i.vlicon-max:hover {
  opacity: .7
}

.vl-notify.vl-notify-alert h2.vl-notice-title .lv-icon-maxmini i.vlicon-mini:hover {
  color: #888
}
...
.vl-notify.vl-notify-alert h2.vl-notice-title .lv-icon-maxmini i.vlicon-huanyuan:hover {
  opacity: .7
}
