<template>
    <div class="adminlogin">
        <div class="adminlogintab">
            <el-breadcrumb separator="/">
                <el-breadcrumb-item :to="{ path: '/' }">首页</el-breadcrumb-item>
                <el-breadcrumb-item>管理员登陆</el-breadcrumb-item>
            </el-breadcrumb>
        </div>
        <div class="adminlogin_inf">ADMIN LOGIN</div>
        <div class="adminlogin_01">
            <div class="adminlogin_01_form">
    ...
    methods:{
        onSubmit(){
            ...
            this.$axios.post('user/login',
                ...
                if(this.inf.msg === "success"&&this.inf.data.role === 0){  // 管理员为0，医生为1，患者为2
        ...
        nopassword(){
            // this.$router.push('/adminForgetPassword');
            alert("请联系管理员");
